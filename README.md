...
Let's be real: this was **vibe-coded** — us and Claude, going full send on features until we ran out of time and shipped it anyway. Zero regrets.

The core works. Some things are half-baked. Some features are code-complete but untested at real scale. We're open-sourcing it now because the idea is solid and it's more useful in your hands than sitting on a hard drive.
